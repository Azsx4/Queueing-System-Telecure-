...
echo "<div class='table-responsive history-table-wrap'><table class='table table-borderless history-table'>";
...
while($row=$result->fetch_assoc()){
    ...
    echo "<td>" . htmlspecialchars($row['reception_name']) . "</td>";
    echo "<td><button class='btn btn-sm btn-primary' onclick=\"event.stopPropagation(); openPrintPopup('kiosk/print.php?id=" . $row['id'] . "')\">Reprint</button></td>";
    echo "</tr>";
}
